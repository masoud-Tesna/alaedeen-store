                        ...
                        <Row className="categoriesMultiColumn--item__row">
                          <Col span={24} className="categoriesMultiColumn--img text-center my-2">
                            <div className="categoriesMultiColumn--img__wrapper">
                              <ShowResponsiveImage imagePath={ category.main_pair.detailed.image_path } imageFolder='detailed' width={ width < 768 ? 73 : 115 } height={ width < 768 ? 73 : 115 } imageAlt={ category.category } object_id={category.category_id}  object_type={'cat'}/>
                            </div>
                          </Col>
